...
"Este projeto visa organizar o conhecimento sobre o ciclo de vida de projetos industriais e a integração de sensores em redes de refrigeração."
## B. Curadoria de Fontes: 
A curadoria foi dividida em **06 rótulos** estratégicos:
*   **Fundamentos de Automação:** 
    *   *Apostila de Automação Industrial* - Prof. Dr. Cesar da Costa.
    *   *Introdução à Norma ISA-101*: Interfaces Homem-Máquina.
    *   *Monitoramento em tempo real*: Benefícios pela SMC.
*   **Indústria 4.0:** 
    *   *Tendências para 2026* - Pensenova.
    *   *Guia IIoT*: Internet Industrial das Coisas.
    *   *Arquitetura para Aplicação de IoT Industrial*.
*   **Materiais de Apoio (Multimídia):** 
    *   *Podcasts*: Introdução a Sistemas Supervisórios, SCADA e Protocolos.
    *   *Slides*: Eficiência energética e integração de IoT em supervisórios.
*   **Protocolos e Redes:** 
    *   *5 Protocolos Industriais Essenciais*.
    *   *Redes Industriais e Integração com Sistemas SCADA*.
*   **Sistemas SCADA:** 
    *   *Boas práticas para desenvolvimento* | ISA SP.
    *   *Características e exemplos de sistemas SCADA*.
*   **Sistemas Supervisórios:** 
    *   *Diferença entre IHM e Sistemas Supervisórios*.
    *   *Vídeos e PDFs técnicos sobre operação*.

##  C. Engenharia de Prompts e "Cicatrizes"

### Prompts que funcionaram:
1.  **Resumo Estruturado:** *"Com base nas fontes fornecidas, crie um resumo estruturado sobre Sistemas Supervisórios. Destaque: 1) O papel vital dos sensores na coleta de dados; 2) Como esses sistemas se integram ao ciclo de vida de um projeto industrial; e 3) A relação entre monitoramento em tempo real e a eficiência operacional."*.
